/*
  # Create site content management system

  1. New Tables
    - `site_content`
      - `id` (uuid, primary key)
      - `content_key` (text, unique) - identifies the content type (hero, about, etc.)
...
-- Allow authenticated users to update content (admin access)
